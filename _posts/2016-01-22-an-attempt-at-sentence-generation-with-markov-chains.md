...
From the generated word list, I created lists of 'triples' containing every single possible 3 consecutive word combination. This list will be used to create the model. These lists do not necessarily need to be of triples, they can have any number of words; however, the generated text becomes less random as the number of words increases.
...
*3 . [agiliq Blog](http://agiliq.com/blog/2009/06/generating-pseudo-random-text-with-markov-chains-u/)*

*4 . [aakashjapi Blog](http://aakashjapi.com/mimicking-writing-style-with-markov-chains/)*
